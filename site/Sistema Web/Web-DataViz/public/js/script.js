...
function cadastrar() {
  ...
  if (tam_cnpj < 14 || cnpj_int != cnpj || cnpj < 0) {
    ...
    continuacao.innerHTML = `
        <div class="campo">
      <span>CEP:</span>
      <input type="number" id="ipt_cep" placeholder="00000000" />
    </div>
    <div class="campo">
      <span>Número:</span>
      <input type="number" id="ipt_num" placeholder="Digite o número" />
    </div>
    <div class="campo">
      <span>Cidade:</span>
      <input
    ...
    <button onclick="cadastrar1()" class="button">Seguinte</button>`;
  } else {
    alert(
